...
namespace Yasc
{
    public class YascControl : UserControl
    {
        ...
        #region Methods
        public YascControl() : this(new GstCam(), new GstCamTest())
        {
        ...
        public YascControl(GstCam gst, GstCamTest gstT)
        {
            InitializeComponent();
            gstCam = gst;
            gsTest = gstT;
        ...
        public void StartPreview()
        {
            ...
            if (gstCam != null)
            {
                ...
                gsTest.HdlPreviewPanel = (ulong)this.pnlPreview.Handle;
        ...
        private void InitializeComponent()
        {
            ...
            this.lblConnStatus.Size = new System.Drawing.Size(0, 17);
