...
namespace AVT.Media.RTSP.Client
{
    ...
    {
        private static readonly MimeType APPLICATION_SPOOFED = MimeType.CreateApplicationType("vnd.AVT.spoofed");
        ...
        public static ImmutableList<MediaTrack> FromSdp(SessionDescription sdp, Uri baseUri, MimeType filter = null)
        {
            ...
            sdp.MediaDescriptions.ForEach(md =>
            {
                ...
                if (mimeType.Is(APPLICATION_SPOOFED))
                {
                    ...
                    // of type application/vnd.AVT.spoofed to indicate to a client that the data is bogus
