...
namespace AVT.Media.Pipeline
{
    ...
    {
        /// <summary>
        /// Defines an empty buffer with no capacity.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return ContentsEqual(obj as ByteBuffer);
        }
        ...
        private bool ContentsEqual(ByteBuffer other)
        {
            ...
            {
                byte b1 = _buffer[_startIndex + i];
                byte b2 = other._buffer[other._startIndex + i];
